...
# PUBLICATIONS
## Peer-reviewed
1. **E.S. Bellis\* **, C.M. McLaughlin\*, C.W. dePamphilis, & J.R. Lasky (2021). The geography of parasite local adaptation to host communities. *Ecography*. \*co-first authors.
...
## Preprints/submitted 
16. **E.S Bellis\* **, A.A. Hashem\*, J.L. Causey, B.R.K. Runkle, B. Moreno-García, B. Burns, V.S. Green, T.N. Burcham, M.L. Reba and X. Huang. Detecting intra-field variation in rice yield with UAV imagery and deep learning. *In review*.
...
>AR EPSCoR DART Seed Grant: LP: AgAdapt: An evolutionarily-informed algorithm for genomic prediction of crop performance in novel environments ($89,194; submitted; role: PI) \hfill{2021}
...
# INVITED TALKS  
Loop Genomics Seminar Series, remote, May 26 \hfill{2021}  
